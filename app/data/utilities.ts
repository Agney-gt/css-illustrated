export const categories = [
  ...
  },
  {
    name: "Effects",
    utilities: [
      { name: "Outline Color", href: "/utilities/effects/outline/color" },
      { name: "Outline Offset", href: "/utilities/effects/outline/offset" },
      { name: "Outline Style", href: "/utilities/effects/outline/style" },
      { name: "Outline Width", href: "/utilities/effects/outline/width" },
      { name: "Ring Color", href: "/utilities/effects/ring/color" },
      {
