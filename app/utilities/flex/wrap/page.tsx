...
export default function FlexWrapPage() {
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 space-y-12 text-foreground">
          ...
          mistakes={[
            {
              ...
              example:
                '<div class="flex-nowrap">Too many items for container</div>',
              level: "critical",
            },
            {
              title: "Not considering gap with wrap",
              reason:
                "Gap applies between items and lines, affecting spacing calculations",
              example:
                '<div class="flex-wrap gap-8">Unexpected large gaps between rows</div>',
              level: "warning",
            },
            {
              title: "Forgetting to constrain item widths",
              reason:
                "Items may become too small when wrapping in narrow containers",
        ...
        <div className="space-y-4 border-t border-border pt-8">
          ...
          <p className="text-muted-foreground">
            Experiment with wrapping, alignment, gap and container width to see
            how wrapping behavior changes.
          </p>
        ...
        <InteractiveChallenge
          ...
          description="This tag cloud has a fixed width. Currently, the tags are set to `flex-nowrap`, causing them to overflow the container and disappear. Change the layout to `flex-wrap` so the tags flow gracefully onto multiple lines."
          codeSnippet={`<div class="w-64 p-4 bg-slate-100 rounded-lg border border-slate-300">
  <div class="flex {input} gap-2">
    <span class="px-3 py-1 bg-blue-500 text-white rounded-full text-xs">#design</span>
    <span class="px-3 py-1 bg-blue-500 text-white rounded-full text-xs">#development</span>
    <span class="px-3 py-1 bg-blue-500 text-white rounded-full text-xs">#ux</span>
    <span class="px-3 py-1 bg-blue-500 text-white rounded-full text-xs">#accessibility</span>
    <span class="px-3 py-1 bg-blue-500 text-white rounded-full text-xs">#css</span>
  </div>
</div>`}
          ...
          renderPreview={(userClass) => (
            <div className="flex items-center justify-center w-full h-full bg-slate-50 dark:bg-slate-950 p-8 rounded-lg overflow-hidden">
              <div className="w-64 p-4 bg-slate-200 dark:bg-slate-800 rounded-lg border border-slate-300 dark:border-slate-700 shadow-md">
  ...
  <span class="px-3 py-1 bg-slate-700 text-white rounded">Closed</span>
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                      ...
                      break layout — keep a compact "More" control for overflow.
                    </p>
                  </div>
                </div>
              </div>
  ...
  <ol class="flex gap-2 flex-wrap items-center text-sm">
    <li>Home</li><li>/</li><li>Products</li><li>/</li><li>Cool sneakers</li>
                    ...
                    />
                    <p className="text-sm text-muted-foreground mt-2">
                      Combine `flex-wrap` with truncation (`max-w` + `truncate`)
                      so breadcrumbs wrap on small screens but remain readable.
                    </p>
                  </div>
                </div>
              </div>
  ...
  ...
                    ...
                    />
                    <p className="text-sm text-muted-foreground mt-2">
                      Week/day strips that wrap let calendar views collapse into
                      multiple rows on narrow screens while preserving the day
                      order.
                    </p>
                  </div>
                </div>
              ...
              tips={[
                {
                  ...
                  text: "Always pair flex-nowrap with overflow-x-auto for horizontal scrolling",
                },
                {
                  bold: "Item sizing:",
                  text: "Constrain item widths or use basis- to control wrapping behavior",
                },
                {
                  bold: "Gap spacing:",
                  text: "Remember gap applies between items and between flex lines",
                },
                {
                  bold: "Responsive design:",
                  text: "Use wrap for responsive galleries and tag clouds",
                },
                {
                  bold: "Performance:",
                  text: "Flex wrap is GPU-accelerated - prefer over manual grid calculations",
                },
              ]}
            />
          </div>
