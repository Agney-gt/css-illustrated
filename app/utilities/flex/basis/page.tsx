...
export default function FlexBasisPage() {
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
          ...
          mistakes={[
            {
              ...
              reason:
                "Fixed basis values can cause overflow in narrow containers",
              example:
                '<div class="basis-96">Very wide content in small container</div>',
              level: "critical",
            },
            {
              title: "Confusing basis with width",
              reason:
                "Basis affects flex calculation, not direct width like in block layout",
            ...
            },
            {
              ...
              reason:
                "Fixed basis without grow leaves unused space in containers",
              example:
                '<div class="basis-1/3">Content doesn\'t fill remaining space</div>',
              level: "info",
            },
          ]}
        />
        ...
        <div className="space-y-6 border-t border-border pt-8">
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm">
              <strong>Demo 1:</strong> Two items switch between <em>25%</em> and{" "}
              <em>50%</em> basis values. This shows how{" "}
              <code className="bg-slate-700 px-1 rounded">flex-basis</code>{" "}
              controls starting width dynamically.
            </p>
            ...
            <div className="flex gap-4 h-32 bg-slate-800 rounded p-4 overflow-hidden">
              <FlexItem
                color="#f56565"
                label="25% → 50%"
                basis={demo1Basis ? "25%" : "50%"}
                grow={1}
              />
              <FlexItem
                color="#ed8936"
                label="50% → 25%"
                basis={demo1Basis ? "50%" : "25%"}
                grow={1}
              />
              <FlexItem
                color="#48bb78"
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm">
              <strong>Demo 2:</strong> Items animate through multiple basis
              values while using{" "}
              <code className="bg-slate-700 px-1 rounded">flex-grow</code> to
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm">
              <strong>Demo 3:</strong> Basis values pulse between two sizes to
              demonstrate how{" "}
              <code className="bg-slate-700 px-1 rounded">flex-shrink</code>{" "}
              affects overflow behavior.
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              Resize or wait for animation to observe shrinking.
            </p>
          </div>
        </div>
        ...
        <InteractiveChallenge
          ...
          description="You want a 3-column layout where each column starts at exactly 1/3 of the width. Currently, they are sized by content (`basis-auto`), making them look uneven. Apply `basis-1/3` to the items to force them into equal columns."
    ...
    Very Long Content That Pushes Width
        ...
        <ExampleSection title="Detailed Real-World Examples">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Each card has a starting width (basis) and grows equally to fill
              remaining space.
            </p>
            <CodeBlock
  ...
  <div class="flex-1 basis-40 bg-blue-300 rounded p-4">Card 4</div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Search input grows to fill available space; logo and button remain
              fixed.
            </p>
            <CodeBlock
  ...
  <button class="basis-24 px-6 py-2 bg-purple-600 text-white rounded">Submit</button>
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Sidebar stays fixed; main content grows dynamically to fill
              remaining space.
            </p>
            <CodeBlock
        ...
        <TipsSection
          tips={[
            ...
            },
            {
              ...
              text: "Use flex-shrink-0 to prevent items from shrinking below their size",
            },
            {
              bold: "Fixed elements:",
              text: "Use flex-none for fixed-size sidebars or buttons in flex containers",
            },
            {
              bold: "Content-based sizing:",
              text: "Use basis-auto for items that should size based on their content",
            },
          ]}
        />
      </div>
