        ...
        <div className="space-y-6 border-t border-border pt-8">
          ...
          <UtilityGrid
            items={[
              {
                cls: "shrink",
                desc: "flex-shrink: 1 — can shrink when needed",
              },
              ...
              {
                cls: "basis-auto shrink-0",
                desc: "Content size + no shrinking",
              },
          ...
          mistakes={[
            {
              ...
              reason:
                "Aggressive shrinking can make buttons, labels, or controls too small to use",
            ...
            },
            {
              ...
              reason:
                "Shrink only works when container has fixed width and overflow occurs",
            ...
            },
            {
              ...
              reason:
                "Text in shrinking items may wrap or truncate unexpectedly",
            ...
            },
            {
              ...
              reason:
                "min-width conflicts with shrink and can prevent intended behavior",
          ...
          renderPreview={(shrinkClass, customClasses = "") => {
            return (
              <div className={`flex gap-4 w-80 ${customClasses}`}>
                <div
                  className={`${shrinkClass} bg-blue-500 p-4 rounded text-white whitespace-nowrap`}
                >
                  Shrinking Item
                </div>
        ...
        <ExampleSection title="Real-World Examples">
            ...
            <div className="flex gap-4 w-80">
              ...
              <div className="shrink">
                ...
                <p className="text-sm text-slate-300">
                  Description text that can shrink
                </p>
              </div>
            </div>
          </ExampleCard>
          ...
          >
            <div className="flex gap-3 items-center">
              <label className="shrink-0 w-24 text-right text-white">
                Name:
              </label>
              <input
                className="shrink flex-1 px-2 py-1 border rounded bg-slate-700 text-white"
        ...
        <div className="space-y-6 border-t border-border pt-8">
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm">
              <strong>Demo 1:</strong> Items cycle through different shrink
              values. Notice how higher shrink values contract more
              aggressively.
            </p>
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm">
              <strong>Demo 2:</strong> Container width changes to show shrink
              behavior. Items only shrink when constrained.
            </p>

            <div className="bg-slate-800 rounded p-4 transition-all duration-1000">
              <div
                className={`flex gap-4 ${
                  demo2Shrink ? "w-64" : "w-96"
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground text-sm">
              <strong>Demo 3:</strong> Form elements demonstrate practical
              shrink behavior with labels and inputs.
            </p>

            <div
              className={`bg-slate-800 rounded p-4 transition-all duration-1000 ${
                demo3Constrain ? "w-80" : "w-full"
              }`}
            >
              <div className="space-y-3">
                <div className="flex gap-3 items-center">
                  ...
                  <input
                    className="shrink flex-1 px-3 py-2 border rounded bg-slate-700 text-white"
