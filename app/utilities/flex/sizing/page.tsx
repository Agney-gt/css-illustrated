          ...
          <div className="space-y-6 border-t border-border pt-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Quick utility classes that set grow, shrink, and basis together.
              </p>
            </div>
            ...
            <div className="border border-border rounded-lg p-6 bg-card/30">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <p className="text-black text-sm font-mono text-accent">
                    flex-auto (grows based on content)
                  </p>
                  <div className="flex gap-4 h-32 bg-slate-800 rounded p-4">
                ...
                <div className="space-y-2">
                  <p className="text-black text-sm font-mono text-accent">
                    flex-initial (no growth, can shrink)
                  </p>
                  <div className="flex gap-4 h-32 bg-slate-800 rounded p-4">
  ...
  <div class="flex-1 bg-green-400 rounded p-4">Grows</div>
          ...
          <div className="space-y-6 border-t border-border pt-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Control how flex items expand to fill available space.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                {
                  class: "flex-grow",
                  desc: "flex-grow: 1 — Grow proportionally",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
            ...
            <div className="border border-border rounded-lg p-6 bg-card/30">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <p className="text-black text-sm font-mono text-accent">
                    flex-grow-0 + flex-grow comparison
                  </p>
                ...
                <div className="space-y-2">
                  <p className="text-black text-sm font-mono text-accent">
                    All items with flex-grow (equal distribution)
                  </p>
                  <div className="flex gap-4 h-24 bg-slate-800 rounded p-4">
  ...
  <div class="flex-grow bg-purple-300 rounded p-4">Grows</div>
          ...
          <div className="space-y-6 border-t border-border pt-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Control how flex items compress when space is limited.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                {
                  class: "flex-shrink-0",
                  desc: "flex-shrink: 0 — No shrinking (maintains size)",
                },
                {
                  class: "flex-shrink",
                  desc: "flex-shrink: 1 — Shrink proportionally",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
            ...
            <div className="border border-border rounded-lg p-6 bg-card/30">
              <h3 className="font-semibold text-foreground mb-4">
                Shrink Demo (Container is constrained)
              </h3>
              <div className="space-y-6">
                <div className="space-y-2">
                  <p className="text-black text-sm font-mono text-accent">
                    Mixed shrink behavior
                  </p>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Resize your browser to see shrinking in action
                  </p>
                </div>
              </div>
              <CodeBlock
  ...
  <div class="flex-shrink w-32 bg-orange-300 rounded p-4 whitespace-nowrap">Shrinks</div>
          ...
          <div className="space-y-6 border-t border-border pt-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Set the default size of a flex item before growth/shrink
                calculations.
              </p>
            </div>
            ...
            <div className="border border-border rounded-lg p-6 bg-card/30">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <p className="text-black text-sm font-mono text-accent">
                    basis as starting point with flex-grow
                  </p>
                  <div className="flex gap-4 h-32 bg-slate-800 rounded p-4">
...
<div class="flex gap-4 h-32">
  ...
  <div class="basis-1/3 flex-grow bg-pink-300 rounded p-4">1/3 + grow</div>
          ...
          <InteractiveChallenge
            ...
            description="This navigation bar has a logo, a search input, and a profile icon. Currently, the search input is too small (`w-24`) and leaves a huge empty gap. Change the search input's class to `flex-1` so it grows to fill all the available empty space."
              ...
              <div className="flex items-center justify-center w-full h-full bg-slate-100 dark:bg-slate-950 p-8 rounded-lg">
                <div className="w-full max-w-md bg-slate-900 text-white p-4 rounded-xl shadow-xl flex items-center gap-4 border border-slate-700">
                  ...
                  <input
                    type="text"
                    className={`
                        bg-slate-800 rounded px-3 py-2 text-sm border border-slate-700 focus:outline-none focus:border-blue-500 transition-all duration-500
                        ${userClass}
                      `}
                    placeholder="Search..."
                    readOnly
  ...
  <button class="px-4 py-2 bg-blue-600 text-white rounded">Sign In</button>
            ...
            <div className="space-y-3">
              <h3 className="text-xl font-semibold text-foreground">
                Responsive Columns with Grow/Shrink
              </h3>
              <CodeBlock
  ...
  <div class="flex-1 basis-64 bg-slate-700 rounded p-6 min-h-40">
    ...
    <p class="text-slate-300">Maintains aspect</p>
            ...
            <div className="space-y-3">
              <h3 className="text-xl font-semibold text-foreground">
                Form with Fixed and Flexible Inputs
              </h3>
              <CodeBlock
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-6 space-y-3">
            ...
            <ul className="space-y-2 text-muted-foreground text-sm">
              <li className="flex gap-2">
                ...
                <span>
                  Use <code className="bg-slate-700 px-1 rounded">flex-1</code>{" "}
                  to create equal-width columns that adapt to container
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-blue-400">•</span>
                <span>
                  ...
                  with{" "}
                  <code className="bg-slate-700 px-1 rounded">flex-grow</code>{" "}
              ...
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  to prevent items from shrinking below their size
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-blue-400">•</span>
                <span>
                  Use{" "}
                  <code className="bg-slate-700 px-1 rounded">flex-none</code>{" "}
                  for fixed-size sidebars or buttons in flex containers
                </span>
              </li>
            </ul>
          </div>
