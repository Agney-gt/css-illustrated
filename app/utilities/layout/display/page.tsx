          ...
          <div className="max-w-7xl mx-auto px-4 py-12 space-y-12 text-foreground">
            ...
            <ComparisonTable
              ...
              rows={[
                ...
                },
                {
                  ...
                  values: [
                    "Horizontal with block properties",
            ...
            <section className="space-y-6 border-t pt-8">
              ...
              <p className="text-muted-foreground">
                Experiment with different display properties and see how they
                affect layout and element behavior.
              </p>
              ...
              <UtilityPlayground
                ...
                buildMarkup={(displayClass, customClasses = "") => {
                  const classes = [displayClass, customClasses]
                    .filter(Boolean)
                    .join(" ");
                ...
                renderPreview={(displayClass, customClasses = "") => {
                  ...
                  return (
                    <div
                      className={`${displayClass} ${customClasses} bg-blue-500 text-white p-4`}
                    >
                      Display Preview
                    </div>
                  );
            ...
            <InteractiveChallenge
              ...
              description="You are building a navigation bar. By default, the links (`<a>` tags) behave as inline elements, or if wrapped in `<div>`s, as blocks. This causes them to stack vertically or squash awkwardly. Change the container's display to `flex` to instantly align them in a neat row."
  ...
  <button class="md:hidden">Menu</button>
              ...
              >
                <nav className="flex justify-between items-center p-4 bg-white shadow rounded-lg">
                  ...
                  <button className="md:hidden px-2 py-1 border rounded">
                    Menu
                  </button>
                </nav>
              </ExampleCard>
...
<div class="block"><span class="inline">Valid nesting</span></div>`,
                ...
                },
                {
                  ...
                  reason:
                    "display: contents removes the parent from accessibility tree, which can break navigation for screen reader users.",
...
<div role="group" class="contents"> <!-- ARIA preserved -->
  ...
  <button>Button 2</button>
                ...
                },
                {
                  ...
                  reason:
                    "When elements are hidden/shown, focus can get trapped or lost. Always manage focus programmatically.",
  ...
  <input autofocus /> <!-- Use JavaScript instead -->
            ...
            <TipsSection
              tips={[
                ...
                {
                  bold: "Performance:",
                  text: "Use simpler display values when complex layouts aren't needed",
                },
                {
                  bold: "Testing:",
                ...
                {
                  bold: "Print styles:",
                  text: "Consider display: none for non-essential content in print media queries",
                },
              ]}
            />
