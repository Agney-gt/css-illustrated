...
export default function AlignItemsPage() {
  ...
  const tips = [
    {
      bold: "items-start:",
      text: "Perfect for top-aligning cards in a flex row",
    },
    {
      bold: "items-center:",
      text: "Ideal for vertically centering navigation items",
    },
  ...
  const commonMistakes = [
    {
      ...
      reason:
        "vertical-align doesn't work with flexbox items. Use align-items instead.",
  ...
  <div class="vertical-align-middle">❌ Won't work</div>
    ...
    },
    {
      ...
      reason:
        "Without height, align-items has no space to work with in column direction.",
    ...
    },
    {
      ...
      reason:
        "Single item has nothing to align with, so alignment appears to have no effect.",
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
          ...
          <UtilityPlayground
            ...
            buildMarkup={(utilityClass, customClasses = "") => {
              const isFlex =
                customClasses.includes("flex") ||
                !customClasses.includes("grid");
  ...
  ${
    isFlex
      ...
      : ""
            ...
            optionLabel={(value) =>
              value.replace("items-", "").replace("-", " ")
            }
          />

          <InteractiveChallenge
            title="The Crooked Nav"
            description="You are building a navigation bar. The logo is tall, but the links are short text. By default, the links stretch or sit at the top, looking awkward. Apply `items-center` to the nav container to vertically center the links with the logo."
