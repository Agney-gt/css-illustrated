          ...
          <div className="max-w-7xl mx-auto px-4 py-12 space-y-12 text-foreground">
            ...
            <section className="space-y-6 border-t pt-8">
              ...
              <p className="text-muted-foreground">
                Experiment with different font sizes and see how they affect
            ...
            <InteractiveChallenge
              ...
              description="This news card has a broken hierarchy. The less important date is huge (`text-2xl`), while the critical headline is tiny (`text-xs`). Fix the visual hierarchy by changing the headline's class to `text-2xl`."
  ...
  <p class="text-sm text-gray-600 mt-2">
    The massive rocket achieved orbit...
              ...
              renderPreview={(userClass) => (
                <div className="w-full max-w-sm p-4 bg-slate-50 dark:bg-slate-900 rounded-xl">
                  <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-3 leading-relaxed">
                      The massive rocket achieved orbit for the first time,
                      marking a new era in space exploration history.
                    </p>
                  </div>
  ...
  Responsive body text
              ...
              >
                <div className="space-y-3">
                  <div className="text-xl md:text-2xl">Responsive Heading</div>
